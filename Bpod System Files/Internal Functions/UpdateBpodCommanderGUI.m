...
for x = ChangedValves
    if BpodSystem.HardwareState.Valves(x) == 1
        set(BpodSystem.GUIHandles.PortValveButton(x), 'string', 'on');
    else
        set(BpodSystem.GUIHandles.PortValveButton(x), 'string', 'off');
    end
end
...
for x = ChangedPWM
    if BpodSystem.HardwareState.PWMLines(x) > 0
        set(BpodSystem.GUIHandles.PortLEDButton(x),'string', 'on');
    else
        set(BpodSystem.GUIHandles.PortLEDButton(x),'string', 'off');
    end
end
...
for x = ChangedV
    if BpodSystem.HardwareState.PortSensors(x) == 1
        set(BpodSystem.GUIHandles.PortvPokeButton(x), 'string', 'on');
    else
        set(BpodSystem.GUIHandles.PortvPokeButton(x),'string', 'off');
    end
end
...
for x = ChangedBNCIn
    if BpodSystem.HardwareState.BNCInputs(x) == 1
        set(BpodSystem.GUIHandles.BNCInputButton(x),'string', 'on');
    else
        set(BpodSystem.GUIHandles.BNCInputButton(x),'string', 'off');
    end
end
...
for x = ChangedBNCOut
    if BpodSystem.HardwareState.BNCOutputs(x) == 1
        set(BpodSystem.GUIHandles.BNCOutputButton(x),'string', 'on');
    else
        set(BpodSystem.GUIHandles.BNCOutputButton(x),'string', 'off');
    end
end
...
for x = ChangedWireIn
    if BpodSystem.HardwareState.WireInputs(x) == 1
        set(BpodSystem.GUIHandles.InputWireButton(x),'string', 'on');
    else
        set(BpodSystem.GUIHandles.InputWireButton(x),'string', 'off');
    end
end
...
for x = ChangedWireOut
    if BpodSystem.HardwareState.WireOutputs(x) == 1
        set(BpodSystem.GUIHandles.OutputWireButton(x), 'string', 'on');
    else
        set(BpodSystem.GUIHandles.OutputWireButton(x),'string', 'off');
    end
end
