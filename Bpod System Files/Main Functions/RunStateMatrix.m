        ...
        switch opCode
            case 1 % Receive and handle events
                ...
                if BpodSystem.EmulatorMode == 0
                   ...
                   % disp(['events read:' TempCurrentEvents])
                else
...
if cli
  switch Events(x)
    case 1
      fprintf('PortSensors(1):%d_',1);
    case 2
      fprintf('PortSensors(1):%d',0);
    case 3
      fprintf('PortSensors(2):%d_',1);
    case 4
      fprintf('PortSensors(2):%d_',0);
    case 5
      fprintf('PortSensors(3):%d_',1);
    case 6
      fprintf('PortSensors(3):%d_',0);
    case 7
      fprintf('PortSensors(4):%d_',1);
    case 8
      fprintf('PortSensors(4):%d_',0);
    case 9
      fprintf('PortSensors(5):%d_',1);
    case 10
      fprintf('PortSensors(5):%d_',0);
    case 11
      fprintf('PortSensors(6):%d_',1);
    case 12
      fprintf('PortSensors(6):%d_',0);
    case 13
      fprintf('PortSensors(7):%d_',1);
    case 14
      fprintf('PortSensors(7):%d_',0);
    case 15
      fprintf('PortSensors(8):%d_',1);
    case 16
      fprintf('PortSensors(8):%d_',0);
    case 17
      fprintf('BNCInputs(1):%d_',1);
    case 18
      fprintf('BNCInputs(1):%d_',0);
    case 19
      fprintf('BNCInputs(2):%d_',1);
    case 20
      fprintf('BNCInputs(2):%d_',0);
    case 21
      fprintf('WireInputs(1):%d_',1);
    case 22
      fprintf('WireInputs(1):%d_',0);
    case 23
      fprintf('WireInputs(2):%d_',1);
    case 24
      fprintf('WireInputs(2):%d_',0);
    case 25
      fprintf('WireInputs(3):%d_',1);
    case 26
      fprintf('WireInputs(3):%d_',0);
    case 27
      fprintf('WireInputs(4):%d_',1);
    case 28
      fprintf('WireInputs(4):%d_',0);
  end
else
  switch Events(x)
    case 1
